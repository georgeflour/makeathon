...
import { Search, Filter, AlertTriangle, Package, Truck, Download, ChevronLeft, ChevronRight } from 'lucide-react'
...
const Button = ({ children, variant = 'primary', size = 'md', onClick, disabled = false, ...props }: ButtonProps) => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {!loading && alerts.length > 0 && (
        <Card className="mb-6" title="Stock Alerts" subtitle={`${alerts.length} items need attention`}>
          <div className="space-y-3">
            {currentAlerts.map((alert) => (
              <div key={alert.sku} className="flex items-center justify-between p-3 rounded-lg bg-orange-50 border border-orange-200">
                <div className="flex items-center">
            ...
            {totalAlertPages > 1 && (
              <div className="flex items-center justify-between mt-4">
                <Button size="sm" variant="secondary" onClick={goToPreviousAlerts} disabled={alertsPage === 1}>
