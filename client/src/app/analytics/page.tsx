          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3 p-4 bg-green-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-green-700">Bundle revenue increased 24.3% compared to individual product sales growth of 8.1%</p>
              </div>
            </div>
            <div className="flex items-start space-x-3 p-4 bg-blue-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700">Focus on retention strategies for high-value customer segment</p>
              </div>
            </div>
            <div className="flex items-start space-x-3 p-4 bg-yellow-50 rounded-lg">
              <Package className="h-5 w-5 text-yellow-600 mt-0.5" />
              <div>
                <p className="font-medium text-yellow-800">Seasonal bundles show strong performance</p>
                <p className="text-sm text-yellow-700">Summer and back-to-school bundles exceed forecasted revenue by 15%</p>
              </div>
            </div>
          </div>
        </Card>
