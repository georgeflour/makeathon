...
#    print(json.dumps(bundle_json, indent=2, ensure_ascii=False))
    ...
    #     target_profit_margin_input=25, 
    #     objective_input="Inventory Goal",
    #     bundle_type_input="LEFTOVER",
    #     duration_input=2 
    # )

    # print("\n Ex3: High margin, specific product number")
    # ai_call(
    #     objective_input="Increase average basket value by 15%",
    #     bundle_size_input="3–4 products",
    #     bundle_type_input="THEME",
    #     target_profit_margin_input="Default (30%)" # Χρήση string απευθείας
    # )

    # print("\n Ex 4:  'type'=\"all\" (bundle_type_input)")
    # ai_call(
    #     bundle_type_input="all", 
    #     objective_input="Maximize overall revenue"
    # )