...
def transform_excel1():
    excel_to_json_first_sheet("Data.xlsx", "Orders.json")


def transform_excel2():
    excel_to_json("inventory_enriched.xlsx", "inventory_enriched.json")

def transform_excel3():
    excel_to_json("product_bundle_suggestions.xlsx", "product_bundle_suggestions.json")
